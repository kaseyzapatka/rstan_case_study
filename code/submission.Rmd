...
priors_tbl <- tibble::tribble(
  ...
  "Intercept", "intercept_lb", 10, 2, "Yes", "Narrowed lower bound to reflect more realistic outcome range",
  "Intercept", "intercept_ub", 20, 6, "Yes", "Narrowed upper bound to better match expected scale",
...
> Why did you change the priors you selected?
 ...
 - I narrowed the range of the intercept (`intercept_lb` and `intercept_ub`) from `10` and $20$ to `2` and $6$ to match 
